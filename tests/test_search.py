...
from game.util import ROOM_CHAR, LEVEL1, Queue, Stack
...
def test_blueprint_problem_in_hallways():
    ...
    dfs_problem = BlueprintSearchProblem(level.layout, start_node, goal_node)
    graph_search(dfs_problem, Stack())
    assert len(dfs_problem.actions) == 57
